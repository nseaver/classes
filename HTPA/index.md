...
Everything you need to know about this course, including schedule, assignments, policies, and so on, can be found on this site. You should look through it all at least once at the start of the semester, though we'll mostly live in the [Schedule](#schedule). We'll only use our Canvas page for submitting certain assignments, keeping track of grades, and sharing PDFs of readings that aren't available through the library.
...
1.  **9/8: Everyone Knows**
    ...
    - Taylor, Henry. 2023. "[Attention as a Patchwork Concept](https://doi.org/10.1007/s13194-023-00538-5)." *European Journal for Philosophy of Science* 13 (3): 36.
    - Counterpoint: Wu, Wayne. 2023. "[We Know What Attention Is!](https://doi.org/10.1016/j.tics.2023.11.007)" *Trends in Cognitive Sciences*, December, 1–15.
...
2.  **9/15: No One Knows**
    ...
    - Anderson, Britt. 2023. "[Stop Paying Attention to 'Attention'](https://doi.org/10.1002/wcs.1574)." *WIREs Cognitive Science* 14 (1): 1–6.
...
3.  **9/22: Driving**
    ...
    - Levy, Karen. 2023. "RoboTruckers: The Double Threat of AI for Low-Wage Work." In *Data Driven: Truckers, Technology, and the New Workplace Surveillance*. Princeton University Press, 119–151. [On Canvas.]
    - McWilliams, Thomas, and Nathan Ward. 2021. "[Underload on the Road: Measuring Vigilance Decrements During Partially Automated Driving](https://doi.org/10.3389/fpsyg.2021.631364)." *Frontiers in Psychology* 12 (April).
    - Doerfler, Aaron, and Luke Stark. 2024. "[Legitimating Emotion Tracking Technologies in Driver Monitoring Systems](https://doi.org/10.1609/aies.v7i1.31645)." *Proceedings of the AAAI/ACM Conference on AI, Ethics, and Society* 7 (1): 396–410.
    - Exercise: Find a video (on YouTube or TikTok, probably) of people trying to defeat a driver monitoring system in some way. Add it to your board with a comment or two.

4.  **9/29: Work**

    ##### Phase 1: Sharing research project candidate lists in class

    Up next: your boss (or [professor](https://community.canvaslms.com/t5/Instructor-Guide/How-do-I-view-the-course-access-report-for-an-individual-user/ta-p/754#U754)) surveilling your computer while you work. There are two pieces by me in here, which you should use as examples of the kind of thing I want you to try with your research projects.

    - Ajunwa, Ifeoma, Kate Crawford, and Jason Schultz. 2017. "[Limitless Worker Surveillance](https://dx.doi.org/10.15779/Z38BR8MF94)." *California Law Review* 105 (3): 735–76.
...
5.  **10/6: Trick Questions**
    ...
    - Berinsky, Adam J, Alejandro Frydman, Michele F Margolis, Michael W Sances, and Diana Camilla Valerio. 2024. "[Measuring Attentiveness in Self-Administered Surveys](https://doi.org/10.1093/poq/nfae004)." *Public Opinion Quarterly* 88 (1): 214–41.
    - Muszyński, Marek. 2023. "[Attention Checks and How to Use Them: Review and Practical Recommendations](https://doi.org/10.18061/ask.v32i1.0001)." *Ask: Research and Methods* 32 (1): 3–38.
...
6.  **10/13: The Attention Economy**
    ...
    - Bietti, Elettra. 2025. "How (Not) to Regulate Attention Platform Business Models." Working paper. [This is on Canvas; Dr. Bietti is kindly sharing this with us in draft form, so do not share beyond the class.]
    ...
    - Brave Software. 2021. "[Basic Attention Token: Blockchain Based Digital Advertising](https://basicattentiontoken.org/static-assets/documents/BasicAttentionTokenWhitePaper-4.pdf)." [This is a whitepaper from a tech company. You only need to read to page 20.]
    - Optional: Explore the (archived) website of the [Attention Trust](https://web.archive.org/web/20060128121120/http://www.attentiontrust.org/about) ("A non-profit organization dedicated to promoting the basic rights of attention owners").

    ##### Phase 1: Information gathering due 10/16

### Two Weeks on Artificial Intelligence

7.  **10/20: Attention Is All You Need**
    ...
    - Lindsay, Grace W. 2020. "[Attention in Psychology, Neuroscience, and Machine Learning](https://doi.org/10.3389/fncom.2020.00029)." *Frontiers in Computational Neuroscience* 14 (April).
    - Seaver, Nick. 2023. "Attention Is All You Need: Humans and Computers in the Time of Neural Networks." In *Scenes of Attention: Essays on Mind, Time, and the Senses*, edited by D. Graham Burnett and Justin E. H. Smith. Columbia University Press, 230–248. [On Canvas.]
    - These are three short blog posts meant to explain in more detail how attention works in machine learning. They are technical, but you should try to read them, mostly to figure out what "attention" means in them. Reading the two pieces above first will help orient you.
        - Olah, Chris, and Shan Carter. 2016. "[Attention and Augmented Recurrent Neural Networks](https://doi.org/10.23915/distill.00001)." *Distill*.
        - Alammar, Jay. 2018. "[Visualizing A Neural Machine Translation Model (Mechanics of Seq2seq Models With Attention)](https://jalammar.github.io/visualizing-neural-machine-translation-mechanics-of-seq2seq-models-with-attention/)."
        - Alammar, Jay. 2018. "[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/)."
    - Optional: You might find [this video explainer](https://www.youtube.com/watch?v=eMlx5fFNoYc) helpful, though it's also rather technical (and you probably only need to watch the first 11 minutes or so for our purposes).

8.  **10/27: The Textpocalypse**
    ...
    - Heckman, Davin. 2023. "[Thoughts on the Textpocalypse](https://doi.org/10.7273/6HJD-MP06)." *Electronic Book Review*.
    - Neal, Derek. 2025. "[Attention is All We Need: On Leif Weatherby's Language Machines](https://3quarksdaily.com/3quarksdaily/2025/08/attention-is-all-we-need-on-leif-weatherbys-language-machines.html)." *3 Quarks Daily*, August 22. [This starts out about AI in general—make sure you get to the end to find the attention-specific stuff.]
    - Mullen, Jac. 2025. "[Attention Machines and Future Politics](https://jacmullen.substack.com/p/attention-machines-and-future-politics)." *After Literacy*, July 27.
    - Kirschenbaum, Matthew. 2023. "[Prepare for the Textpocalypse](https://www.theatlantic.com/technology/archive/2023/03/ai-chatgpt-writing-language-models/673318/)." *The Atlantic*, March 8.

### Four Weeks on Attentional Subjects

9.  **11/3: The New Tech Humanism**
    ...
    - Video: Center for Humane Technology. 2018. "[Humane: A New Agenda for Tech](https://www.youtube.com/watch?v=09Jeyu4-Fcc)." [1:16:00, starts at 6:45. There are two talks in here, plus a guided meditation. It's from the 2018 launch event for the Center For Humane Technology, which you read about in my chapter earlier.]
    - Ganesh, Maya Indira. 2018. "[The Center for Humane Technology Doesn't Want Your Attention](https://thesocietypages.org/cyborgology/2018/02/09/the-center-for-humane-technology-doesnt-want-your-attention/)." *Cyborgology*, February 9.
    - Tarnoff, Ben and Moira Weigel. 2018. "[Why Silicon Valley Can't Fix Itself](https://www.theguardian.com/news/2018/may/03/why-silicon-valley-cant-fix-itself-tech-humanism)." *The Guardian*, May 3.
    - Jablonsky, Rebecca. 2022. "[Meditation Apps and the Promise of Attention by Design](https://doi.org/10.1177/01622439211049276)." *Science, Technology, & Human Values* 47 (2): 314–36.

    ##### No class 11/10 (Tufts runs a Wednesday schedule)

10. **11/17: The Manosphere**
    ...
    - Taylor, Kris, and Sue Jackson. 2018. "['I Want That Power Back': Discourses of Masculinity within an Online Pornography Abstinence Forum](https://doi.org/10.1177/1363460717740248)." *Sexualities* 21 (4): 621–39.
    ...
    - James, Robin. 2025. "[We're Through Being Cool: Techbros, Manosphere Influencers, Ancient Greek Masculinity, and AI](https://www.its-her-factory.com/2025/08/were-through-being-cool-techbros-manosphere-influencers-ancient-greek-masculinity-and-ai/)." *It's Her Factory*, August 7.
    - I've gathered some examples of attention-specific manosphere content from YouTube. You don't have to watch all of it, but I suggest browsing through to familiarize yourself with common tropes, if you haven't encountered them already. You're welcome to look around to other sources you've heard of online to bring examples to class. I suggest using incognito mode—recommender systems love this stuff:
        - [Andrew Tate on Giving Too Much Attention to Women](https://www.youtube.com/watch?v=3FyV-OecFc0) [3:05]
        - [STOP Looking At Women](https://www.youtube.com/watch?v=85fc0UxDatU) [17:47; especially toward the end]
        - [Female Attraction When You Retain](https://www.youtube.com/watch?v=GMa6dE7qucM) [15:04]
        - [Attention Addicts Are Drawn To You On Semen Retention](https://www.youtube.com/watch?v=AFx7oXpKJY0) [11:32]
        - [Feminine Men Are Desperate For Attention](https://www.youtube.com/shorts/eHJSH0Ai_Jk) [0:53]
        - [Stay Focused! #semenretention](https://www.youtube.com/shorts/tswynzMBExY) [0:11]

11. **11/24: Looking at Art**
    ...
    - Video: Herman, Amy. 2016. "[Visual Intelligence](https://www.youtube.com/watch?v=4v_tn4nyjwE)." Talks at Google. [51:24]
...
12. **12/1: ADHD**
    ...
    - Filipe, Angela M. 2016. "[Making ADHD Evident: Data, Practices, and Diagnostic Protocols in Portugal](https://doi.org/10.1080/01459740.2015.1101102)." *Medical Anthropology* 35 (5): 390–403.
    - Nielsen, Mikka. 2018. "[Structuring the Self: Moral Implications of Getting an ADHD Diagnosis](https://doi.org/10.1080/00141844.2017.1362454)." *Ethnos* 83 (5): 892–908.
    - Austin Locke, Toby. 2023. "[In the Cracks of Attention: ADHD, Vernacular Anthropologies and Communities of Care on TikTok](https://doi.org/10.22582/ta.v12i1.683)." *Teaching Anthropology* 12 (1): 23–35.
    - Morrison, Hazel, Shannon McBriar, Hilary Powell, et al. 2019. "[What Is a Psychological Task? The Operational Pliability of 'Task' in Psychological Laboratory Experimentation](https://doi.org/10.17351/ests2019.274)." *Engaging Science, Technology, and Society* 5 (March): 61–85.

13. **12/8: Presentations!**
...
- Our meetings are 2.5 hours long. An appropriately-sized makeup task should take you about this long to complete (on top of the time you should have already spent doing the reading).
- I do not want skipping class to be more appealing than coming to class when you're feeling like you have too much work to do (which is just about guaranteed to happen eventually).

So, informed by that, this is the make-up policy:

- You can miss one class meeting without any penalty. You don't need to email me with an excuse or feel bad about it or anything, and I do not care if you have a good reason. (Having a "good" reason doesn't earn you extra free skips!)
- After that, you can miss one more class without penalty, so long as you complete a make-up assignment. The assignment is a collection of tasks:
    - Look at the reference lists of the readings for the week (i.e. the texts that our readings cite; remember that you should still be doing the assigned readings and completing your commonplace board, even if you can't attend class). Pick something referenced in the week's readings that looks interesting to you and read it. (This should be something article- or chapter-length, like our usual readings; if you find a book that looks interesting, you can just read the introduction.)
    - Find an object relevant to the week's theme from outside of class. (For example, in our week on driving, you might find a video documenting the attention detection features in a particular model of car. There are lots of possibilities here, but I'm looking for an object, not a text—you shouldn't, for instance, submit a blog post about attention measurement in cars in general, though a blog post that describes a particular system could represent your "object.")
    - Look through your classmates' commonplace boards for the week and find cards that catch your interest. You should copy these (they might be quotes from readings, comments made on them, or anything else), keeping track of whose board they came from and any other source information.
    - Take all that stuff (your extra reading, your outside object, and your material of interest from other boards), and write about it on your own commonplace board. You can arrange this however you like, but I expect to see some description of what your extra reading was about and some explicit connections between it, your object, and materials gathered from your classmates' boards. This is in addition to the basic weekly commonplace board updating.
    - Once you've done this, send me an email letting me know it's done (and where to find it on your board), and I'll take a look at it. It should be roughly comparable in scope to the regular weekly board update. I'll let you know if it's adequate, or if you need to work on it more.
    - All makeup work should be completed within two weeks of your absence, to ensure you're not falling behind. [If you're in really dire straits and this timeline seems impossible, send me an email and we can arrange something equitable. Note that there are hard limits to time at the end of the semester.]
- After your second absence (i.e. your first make-up), no more make-ups are possible, and absences will count against your participation grade. (At this point, you'd be missing almost a quarter of the class meetings and should consider whether you actually have time for the course.)

### Commonplace Board (20%)

The first time I taught this class, back in 2017, I had students keep a physical journal to record notes, plan their final projects, and collect thought-provoking materials. (See the marvelous [Syllabus](https://www.commonscomics.com/2017/draw-for-your-life-review-of-syllabus-notes-from-an-accidental-professor-by-lynda-barry/), by Lynda Barry.) Inspired by a [version of this assignment made by Ryan Cordell](https://canvas.illinois.edu/courses/60182/pages/commonplace-book-assignment), I'm bringing it back, in altered form. (Some of this page is adapted from his assignment to maintain a course "commonplace book"—a traditional way of gathering meaningful quotations, memories, and other textual or flat materials. Here's [a nice blog post](https://ayushithakkar.substack.com/p/how-to-start-a-commonplace-book-and) about analog commonplace books, which you may find inspirational.)

#### Kinopio

This time, we're going digital, using [Kinopio](https://kinopio.club)—a weird and opinionated little mind-mapping/conspiracy wall-making platform. I'm a long-time fan of the site and its small-scale ethos, and I've used it successfully in a few prior iterations of this course. If you've used collaborative canvas-editing platforms like Miro or Jamboard, you'll be familiar with the general idea, though Kinopio is a bit distinctive. Basically, you can make cards with text or images and connect them. Here's an [example board](https://kinopio.club/htpa-kinopio-primer-2025-dKbT11-ZUFC_Ii-Y11vgm) I made to demonstrate some of the site's features. I've collected more boards for inspiration in a list at the bottom of this section.
...
- It should be portable (i.e. the size of a composition book or smaller).
- It should be dedicated entirely to this class.
- You should have some way of including images and referring to digital materials. (Get creative, but obvious options include drawing pictures or printing things out from the computer and taping/pasting them in.)
- You should bring it to class every week.
- You'll need to document it digitally: take pictures of the pages, revisit them after class, and put them on your Kinopio board each week. (This is so that other students can see your work, and so that I can evaluate it.)
- This may be harder to manage for the project work-in-progress stuff. You're welcome to do that digitally even if you do the regular weekly stuff on paper.
- In class and on this site, I'll talk like everyone is working digitally, and you'll have to translate into analog terms. (Of course if something seems impossible to do in your notebook, tell me and we'll figure something out.)
...
- [Kinopio Roadmap](https://kinopio.club/-kinopio-roadmap-3CBHtivu7X7nTzrcaTFQV)
- [Changelog](https://kinopio.club/changelog-6lsytK8ZfOtMl2oqG05Rj)
- [Ideation workflow](https://kinopio.club/-ideation-workflow-copy-d5RdmduZzTJdGzgQnkkt3)
- [Moose test for LLMs](https://kinopio.club/moosetest-for-llms-33N1NVrvVfZ1caexVcLSR)
- [Spirit of Kinopio](https://kinopio.club/spirit-of-kinopio-QFfjka9cMLwC19h2HqJ96)
- [The End of Gameplay](https://kinopio.club/the-end-of-gameplay-6-xKvf3KyDRfjYpSPCVN-)
- [HTPA Synthesis 1: Walking](https://kinopio.club/htpa-1-synthesis-walking-2fa92Dto9CWd6mJJlkaBy) (This is from an earlier iteration of this very course, when we worked as a group on a shared weekly board and two students were responsible for cleaning it up and synthesizing everything afterwards.)

### Research Project: Attention Measurement Systems

The major assignment in this course is a multi-phase research project, in which you'll find an attention measurement system and study it in excruciating detail. In the first phase, you'll identify candidates, choose one, and amass a lot of information about it. In the second phase, you'll focus on the kinds of attentional subjects your system is meant to manage. In the third phase, you'll come up with a technique to fool your attention measurement system, informed by what you've learned about it and its contexts of use. At the end, you'll aggregate all this research into a summative report. The phases have multiple internal deadlines, listed below as well as on the [Schedule](#schedule) above, for easy reference. Each numbered component is specs graded separately (so, you'll get 5 points or nothing for your list of candidate systems, 10 points for information gathering, and so on).
...
- How does it work? Literally, technically, what sequence of operations occurs when your system runs? Try to find a diagram or to make one of your own. Does this vary?
- What components are involved in its functioning—sensors, software, and so on? Are they designed specifically for this purpose or borrowed from somewhere else? What were they originally for?
- What theories is it based on? Is there a scientific literature you might look into? (This is where you might move up in abstraction to look at something like how eye tracking in general works.)
- What settings is it used in? (Cars, offices, multiple different settings, etc.)
- Where do people talk about it? (This may range from scientific subfields dedicated to its theoretical underpinnings to worker forums where people talk about dealing with it on the job.)
- When did it start being used? Did it replace something else? Did it come from somewhere else (i.e., did it originally serve some other purpose)?
- What problems is it involved with? Does it solve any particular problems for someone? Does it cause problems? Does it change the distribution of problems in the setting where it's used?
- Who uses it? Are there multiple kinds of user? Who owns it? Who maintains it? Who designed it? Sketch out a list or map of the kinds of people involved with it. (This will come in handy in phase 2.)
...
These questions are lifted directly from Joe Dumit's "implosion" project, which is based on the teaching work of Donna Haraway. You're invited to read [the original article](https://journal.culanth.org/index.php/ca/article/view/ca29.2.09/301), if you're interested in the scholarly context for asking questions like these. (You'll find some intriguing attention-related framing in there.)
...
- What defines the limits of your attentional subject? How do people know if someone is in or out of that group? Do people within the group have different ways of doing this than people outside the group?
- How are they supposed to pay attention? Are there typical expectations? Tensions?
- How are expectations of attention enforced? Are there consequences for not attending like they're supposed to? What kind of consequences? Do they vary?
- What other kinds of people are related to them? (For instance, teenagers might have connections to groups like parents or teachers.) What are those relations like?
- Now think about them in relation to your measurement system: Do they talk about it? What do they say? Are there controversies? Particular points of concern or debate? Is anything changing? (Your measurement system was, at some point, new—can you find any discourse related to its initial release?)
- Can you find evidence of your subjects trying to manipulate your attention measurement system? (This may come in handy for Phase 3.)
...
- Look for existing subterfuge techniques from the previous phase; if you find any, you'll want to document them on your board (and this phase may look more like research into existing subterfuge techniques). If you don't find any, that's okay.
- It may not be obvious what it means to "trick" your system—if it's not so simple as "people at work use mouse jigglers," you might start to think more expansively: Who might be doing the tricking? Who might they be trying to trick? This doesn't necessarily have to be the same kind of person as in the attentional subjects phase, though that would be the ideal.
- Visual aids: You should probably draw a diagram, sketch a flowchart, produce a photocollage, or make some kind of visual representation of your technique. You can also produce a physical artifact to bring to class for presentations, if you want.
- Countermeasures: How might your efforts to trick the system be detected or defeated? (If you're talking about techniques you've found in the wild, how are they detected or defeated?)
- Counter-countermeasures: Speculate more here, and think about how you could defeat those countermeasures that would stop your efforts at trickery. If it feels interesting to you, keep going: What might happen as this arms race continues?
- Put whatever ideas you're working with in a box on your project board so I can find them.
...
- Cite your sources in some consistent style. There are no requirements about how many sources or which style. (If you're looking for a reference style, I recommend Chicago author-date.)
- You should include reference to relevant sources from the class reading list.
- Address all three of the prior phases of research. (Though, as mentioned, you don't have to cover them all equally, and you don't have to organize your report around them as sections or anything like that.)
- Length: I expect these to come in somewhere between 2500 and 3500 words. That's a big range, partly to leave some flexibility, and partly because what you'll need to do to be thorough may vary depending on the previous phases. Just because you've passed the minimum length threshold, that does not mean your report is long enough, if it's missing important components of your prior research.
...
- For work that exceeds expectations, you'll get an A+ (100%) in the gradebook. This allows me to reward exceptional work without punishing students who consistently meet the specs. You should not expect to get this regularly, and you should not need to, either.
...
As you'll notice, I'm expecting you to use a computer in the classroom this semester. This is counter to a lot of [current ideas](https://www.nytimes.com/2025/08/21/opinion/mobile-phones-college-classrooms.html) about how to manage the attention of students, but I think it is worth the tradeoff to have materials ready at hand. (Also, you may guess that I have some opinions about how people talk about managing student attention.) You should only be using your computer for course-related work during class time. I may ask you to close the laptop if it seems like a distraction for you, and if we don't need the computers for something, I'll ask everyone to shut them.
...
For disability-related accommodations, I encourage you to consult with the [StAAR Center](https://students.tufts.edu/staar-center/accessibility-services/register-accommodations), which can arrange for formal accommodations across your classes. But you do not need to register with them or provide documentation to me in order to request accommodations in this course.
