...
description: "Mid-level course in anthropological theory: examines technologies made to entice, lure, and persuade, in social and cultural context. Compares the design, use, and reception of techniques ranging from animal trapping to user experience design."
layout: default
---
[Assignments](#assignments) [Schedule](#schedule) [Policies](#policies)
...
You don't need to [register with the StAAR Center](https://students.tufts.edu/staar-center/accessibility-services/register-accommodations) or have a documented disability to request accommodations from me. However, you may find the support they offer useful, and I encourage you to get in touch with them.
